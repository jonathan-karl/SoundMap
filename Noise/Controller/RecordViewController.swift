...
class RecordViewController: UIViewController, AVAudioRecorderDelegate,  UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, CLLocationManagerDelegate {
